 ...
 * The console derives rows from the scenes themselves now (../sources/placements), so a
 ...
 * `useBindingScenes` (program + preview only) went with them — ../sources/placements
